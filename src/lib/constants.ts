/** JioSaavn's private `api.php` context parameter. Android returns a superset of endpoints unavailable to web. */
export type JioSaavnContext = 'web6dot0' | 'android'

/** `__call` values for JioSaavn's private `api.php`, grouped by the resource that consumes them. */
export const JioSaavnEndpoint = {
  ...
  albums: {
    byId: 'content.getAlbumDetails',
    byLink: 'webapi.get'
  },
  artists: {
    byId: 'artist.getArtistPageDetails',
    byLink: 'webapi.get',
